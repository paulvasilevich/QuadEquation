...
//            DatabaseUsers.messagesFinance.put(user, newMessage);
//        }
            ...
            out.println("<body>");
            out.println("<center>");
            out.println("<h1>Finance room our forum.</h1>");
            out.println("</center>");
            out.println("<h2 align = \"right\">You are logged as " + user + "</h2>");
        for (String s : DatabaseUsers.messagesFinance.keySet()) {

            out.println("<p>" + s + ":&nbsp");
            out.println( DatabaseUsers.messagesFinance.get(s).getMessage() + ":&nbsp</p>");
            out.println( "<br/>");
            if (DatabaseUsers.messagesFinance.size() > 0) {
                out.println("<hr/>");
            }
        }
//            try {
...
//                        "FROM Forum.finance ORDER BY id");
...
//            }
            ...
            if (loginStatus) {
                out.println("<form action=\"/finance.room\" method=\"post\">\n" +
